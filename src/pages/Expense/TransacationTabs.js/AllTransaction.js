...
const AllTransaction = ({ transactions, TitleBar, FilterBar }) => {
    ...
    <div>
      ...
      >
        <Column width={50} align="center">
          <HeaderCell>
            <Checkbox
              inline
              checked={checkedKeys.length === filteredData.length}
              indeterminate={
        ...
        <Column width={160} flexGrow={1} sortable>
      ...
      >
        ...
        <div className="text-black font-medium text-base">
          Total:{" "}
          <span className="ml-1.5 bg-gray-800 text-white py-1.5 px-4 text-lg rounded-md total-income">
